...
import com.zhang.yong.quit.programminglearning.filters.ShiroSessionFilter;
import com.zhang.yong.quit.programminglearning.security.shiro.CustomRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(Realm realm) {
        ...
        filterChainDefinitions.put("/admin/verify", "anon");
        filterChainDefinitions.put("/admin/redirect", "anon");
        filterChainDefinitions.put("/admin/kaptcha", "anon");
        filterChainDefinitions.put("/admin/isServerAlive", "anon");
        filterChainDefinitions.put("/admin/unauthc", "anon");
        filterChainDefinitions.put("/redis/**", "anon");
        filterChainDefinitions.put("/electronic/contract/**", "anon");
